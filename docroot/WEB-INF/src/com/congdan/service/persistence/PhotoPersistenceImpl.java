...
import com.congdan.NoSuchPhotoException;

import com.congdan.model.Photo;
import com.congdan.model.impl.PhotoImpl;
import com.congdan.model.impl.PhotoModelImpl;
...
public class PhotoPersistenceImpl extends BasePersistenceImpl<Photo>
	...
	@Override
	public Photo updateImpl(com.congdan.model.Photo photo)
	...
	protected Photo toUnwrappedModel(Photo photo) {
		...
		photoImpl.setPhotoName(photo.getPhotoName());
		photoImpl.setOwner(photo.getOwner());
		photoImpl.setData(photo.getData());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.congdan.model.Photo")));
