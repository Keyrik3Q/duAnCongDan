...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
	...
	*/
	...
	@Override
	public int compareTo(com.congdan.model.Foo foo) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.congdan.model.Foo> toCacheModel() {
		return _foo.toCacheModel();
	}

	@Override
	public com.congdan.model.Foo toEscapedModel() {
		return new FooWrapper(_foo.toEscapedModel());
	}

	@Override
	public com.congdan.model.Foo toUnescapedModel() {
