...
/**
 * The base model interface for the Foo service. Represents a row in the &quot;QuanLyCongDan_Foo&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link com.congdan.model.impl.FooModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link com.congdan.model.impl.FooImpl}.
 * </p>
 *
 * @author ADMIN
 * @see Foo
...
public interface FooModel extends BaseModel<Foo>, GroupedModel {
	...
	@Override
	public CacheModel<com.congdan.model.Foo> toCacheModel();
