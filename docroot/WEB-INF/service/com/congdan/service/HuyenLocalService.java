...
/**
 * Provides the local service interface for Huyen. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ADMIN
 * @see HuyenLocalServiceUtil
...
public interface HuyenLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link HuyenLocalServiceUtil} to access the huyen local service. Add custom service methods to {@link com.congdan.service.impl.HuyenLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
