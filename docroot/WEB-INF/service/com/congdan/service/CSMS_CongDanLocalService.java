...
/**
 * Provides the local service interface for CSMS_CongDan. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ADMIN
 * @see CSMS_CongDanLocalServiceUtil
...
public interface CSMS_CongDanLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CSMS_CongDanLocalServiceUtil} to access the c s m s_ cong dan local service. Add custom service methods to {@link com.congdan.service.impl.CSMS_CongDanLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
