...
/**
 * Provides the local service interface for CSMSCongDan. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ADMIN
 * @see CSMSCongDanLocalServiceUtil
...
public interface CSMSCongDanLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CSMSCongDanLocalServiceUtil} to access the c s m s cong dan local service. Add custom service methods to {@link com.congdan.service.impl.CSMSCongDanLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
