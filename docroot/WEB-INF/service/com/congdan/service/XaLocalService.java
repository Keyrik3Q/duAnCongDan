...
/**
 * Provides the local service interface for Xa. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ADMIN
 * @see XaLocalServiceUtil
...
public interface XaLocalService extends BaseLocalService, InvokableLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link XaLocalServiceUtil} to access the xa local service. Add custom service methods to {@link com.congdan.service.impl.XaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
